...
export const startSession = ({ args = [], headless = 'auto', customConfig = {}, proxy = {} }) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            var chromePath = process.env.PUPPETEER_EXECUTABLE_PATH //''//customConfig.executablePath || customConfig.chromePath || chromium.path;
            ...
            '--disable-features=AudioServiceOutOfProcess'].concat(args);
